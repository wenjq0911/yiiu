    ...
    <div class="panel panel-default">
      ...
      <div class="row panel-body">
          <div class="col-lg-12 col-md-12">
              ...
              <div class="row" >
                  <div class="col-md-5">
                      <div id="system_pie" style="height: 300px"></div>
                  </div>
                  <div class="col-md-7">
...
<script>
    var dom = document.getElementById("system_pie");
    var option = null;
    var myChart = echarts.init(dom);
    $.ajax({
        url: "/admin/node/getPie",
        async: true,
        cache: false,
        type: "get",
        dataType: "json",
        success: function (data) {
            if (data.code === 200 && data.detail.length>0) {
                option = {
                    title : {
                        text: '',
                        subtext: '',
        ...
        success: function (data) {
            if (data.code === 200 && data.detail.length>0) {
                ...
                for(var i=0;i<data.detail.length;i++){
                    if(max<data.detail[i].value)
                        max=data.detail[i].value;
                }
                map_option = {
                    title: {
                        text: '',
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.code === 200 && data.detail.length>0) {
                ...
                var y=[];
                for (var i=0;i<data.detail.length;i++){
                    x.push(data.detail[i].name);
                    y.push(data.detail[i].value);
                }
                line_option = {
                    xAxis: {
                        type: 'category',
